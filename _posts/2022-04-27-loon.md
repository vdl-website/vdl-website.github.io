...
We published a paper describing this technique at last year’s VIS conference. We’re also very excited that the paper won an **honorable mention for best paper**! If you’re interested, check out the details in [the paper]({{site.base_url}}/publications/2021_vis_loon/) or watch a recording of the [conference presentation](https://youtu.be/Xz5VrBXk5J0).
