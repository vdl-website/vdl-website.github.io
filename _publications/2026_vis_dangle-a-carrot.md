...
key: 2026_vis_dangle-a-carrot
type: paper
order: 2026-8

shortname: "Should We Dangle a Carrot?"
image: 2026_vis_dangle-a-carrot.png
image_large: 2026_vis_dangle-a-carrot_teaser.png
image_alt_text: "Teaser graphic describing the central research question investigated in the study---given the exact same task, would a participant who is (a) given a larger fixed amount, or (b) a smaller fixed amount _and_ performance-based bonuses would perform better in the task?"
...
preprint_server: https://arxiv.org/abs/2607.07463
...
supplement: 2026_vis_dangle-a-carrot_supplement.zip

code: https://github.com/abhsarma/adversarial-effects-experiment
